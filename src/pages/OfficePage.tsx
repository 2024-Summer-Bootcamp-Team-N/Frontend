...
const OfficePage = () => {
  ...
  const parking =
    state?.parking === '상관없음'
      ? '상관없음'
      : state?.parking === '세대당 1대 이상'
        ? '주차 1대'
        : state?.parking === '세대당 2대 이상'
          ? '주차 2대'
          : '';
  const rooms =
    state?.rooms === '상관X'
  ...
  return (
    <div className="flex flex-col min-h-screen w-full h-full overflow-hidden bg-white">
      ...
      <div className="flex relative w-full h-[61px] justify-start items-center font-[NanumSquareRoundB] text-[16px] text-black border-b-[1px] border-[#EBEBEB]">
        ...
        <div className="flex w-[100px] h-[35px] mx-[10px] justify-center items-center rounded-[30px] bg-white border border-[#357fff]">
          <p className="flex font-[NanumSquareRoundB] text-[16px] text-[#357fff]">{parking}</p>
        </div>
        <div className="flex w-[100px] h-[35px] ml-[10px] justify-center items-center rounded-[30px] bg-white border border-[#357fff]">
          <p className="flex font-[NanumSquareRoundB] text-[16px] text-[#357fff]">{rooms}</p>
        </div>
        <span className="border-l-2 border-[#E0E0E0] h-[19px] mx-[20px]" />
        <div
          className={`flex flex-row justify-start items-center w-[100px] h-[35px] rounded-lg ${
        ...
        <div
          className={`flex flex-row justify-start items-center w-[100px] h-[35px] mx-[20px] rounded-lg ${
        ...
        <div
          className={`flex flex-row justify-start items-center w-[110px] h-[35px] rounded-lg ${
