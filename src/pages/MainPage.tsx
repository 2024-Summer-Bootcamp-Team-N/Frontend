  ...
  return (
    <div className="relative w-full bg-white overflow-hidden">
      ...
      <div className="flex flex-col items-center w-full h-full bg-white mt-[72px]">
        <div
          className="flex flex-col justify-center w-screen h-[1000px] font-[NanumSquareRoundB] bg-cover bg-center -mt-[10px] overflow-hidden"
        ...
        <div className="w-full flex flex-col items-center">
          <div className="flex flex-col md:flex-row w-full bg-[#f8f9fa]  mt-[300px]  items-center">
            <div className="flex-1 text-left ml-[10%] font-[NanumSquareR] md:pr-8">
              <p className="text-5xl font-[NanumSquareEB] mb-[80px] ">당신의 집은 어디에 있나요?</p>
          ...
          <div className="flex flex-col md:flex-row w-full bg-[#c5d9fe]/40  items-center mt-[300px]">
            <img
              ...
              data-aos-delay="300"
            />
            <div className="flex-1 md:pl-8 text-left ml-[10%] font-nanumSquareR">
              <p className="text-5xl font-[NanumSquareEB] mb-[80px]">모르는게 당연해요!</p>
          ...
          <div className="flex flex-col md:flex-row w-full bg-[#f5e5dd]/40   items-center mt-[300px] mb-[300px]">
            <div className="flex-1 md:pr-8 ml-[10%] font-nanumSquareR text-left">
              <p className="text-5xl font-[NanumSquareEB] mb-[80px]">당신의 첫 계약</p>
