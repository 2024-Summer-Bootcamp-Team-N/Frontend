    ...
    <>
      <div className="flex flex-col fixed bottom-0 right-0 w-[424px] h-[886px] bg-white border-[1.5px] border-[#EBEBEB]">
        <div className="flex justify-end p-2">
          <button onClick={onClose} className="absolute right-1 top-2 opcity-100 hover:bg-gray-200">
            <svg
              width={42}
              height={42}
              viewBox="0 0 42 42"
        ...
        <div className="flex flex-row justify-center items-center border-b-[1.5px] border-[#EBEBEB] w-full h-full max-h-[25%]">
          <img src="매물이미지.jpeg" alt="추가예정" className="w-[166px] h-[166px] border-[2px] flex object-cover" />
          <div className="flex-col ml-[15px]">
            ...
            <p className="flex flex-col w-full   left-[212px] text-sm text-left font-nanumSquareRoundR text-black">
